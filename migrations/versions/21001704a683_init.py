...
Revision ID: 21001704a683
Revises: 
Create Date: 2026-05-09 18:25:27.602119
...
def upgrade() -> None:
    ...
    op.create_table('shipment',
                    ...
                    sa.Column('status', sa.Enum('placed', 'shipped',
                                                'in_transit', name='shipmentstatus'), nullable=False),
