...
from app.api.dependencies import ShipmentDep
...
async def get_shipments(id: int, service: ShipmentDep):
    ''''
...
async def submit_shipment(incoming_shipment: shipment.ShipmentCreate, service: ShipmentDep,) -> models.Shipment:
